...
# Path to the OpenDataset v2 ontology file
OPENDATASET_V2_ONTOLOGY_PATH = (
    Path(__file__).parent.parent.parent
    / "__assets__"
    / "opendataset_v2_ontology.yaml"
)
...
class TestOpenDatasetV2OntologySchema:
    """Tests for validating the OpenDataset v2 ontology against the schema."""

    def test_ontology_file_exists(self):
        assert OPENDATASET_V2_ONTOLOGY_PATH.exists()

    def test_ontology_valid_yaml(self):
        ontology_dict = _load_ontology(OPENDATASET_V2_ONTOLOGY_PATH)
...
class TestOpenDatasetV2ExpectedClasses:
    """Tests to ensure all expected OpenDataset v2 classes are present."""
...
class TestOpenDatasetV2OcclusionFormat:
    """Tests for OpenDataset v2 specific occlusion value format."""
...
class TestOpenDatasetV2SignalAspects:
    """Tests for OpenDataset v2 signal aspect options."""
    ...
    def test_signal_aspect_options_present(self):
        ...
        expected_aspects = [
            "Hp_0_light", "Hp_0_shape", "Hp_1_light", "Hp_1_shape", "Hp_2_light", "Hp_2_shape",
            "Ks_1", "Ks_2",
            "Vr_0_light", "Vr_0_shape", "Vr_1_light", "Vr_1_shape", "Vr_2_light", "Vr_2_shape",
            "Zs_2", "Zs_2v", "Zs_3_light", "Zs_3_shape", "Zs_3v_light", "Zs_3v_shape",
            "Sh_0_light", "Sh_0_shape", "Sh_1_light", "Sh_1_shape", "Sh_2_shape",
            "other_light", "other_shape", "invalid", "unknown"
        ]
...
class TestOpenDatasetV2PersonalItemAndPram:
...
class TestOpenDatasetV2AnimalSpecies:
    ...
    def test_animal_species_comprehensive(self):
        ...
        expected_species = [
            "dog", "cat", "racoon", "badger", "swan", "sheep", "cow", "horse",
            "pig", "fox", "wolf", "wildBoar", "deer", "stork", "rabbit", "bird"
        ]
